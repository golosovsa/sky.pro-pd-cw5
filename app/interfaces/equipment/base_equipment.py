...
from .abstract_equipment import AbstractEquipment
from ..equipment_data import \
    BaseEquipmentData as EquipmentData, \
    BaseEquipmentDataSchema as EquipmentDataSchema
from ..weapon import BaseWeapon as Weapon
from ..armor import BaseArmor as Armor


class BaseEquipment(AbstractEquipment):
